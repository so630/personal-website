...
export default function ProfileDescription() {
    ...
    return (
        <div className={styles.profileDescription}>
            ...
            <p ref={ref4} className={styles.closeRight}>I am a full stack web and mobile app developer currently studying in year 10 at high school. I am also into system programming as a hobby.</p>
        </div>
    )
}
